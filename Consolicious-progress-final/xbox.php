...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['paymentProof']) && $_FILES['paymentProof']['error'] == 0) {
        ...
        if (move_uploaded_file($fileTmpPath, $uploadFile)) {
            // Daftar harga per jenis xbox
            $prices = [
                'Xbox Series X' => 20000,  // Harga per jam untuk xbox5
                'Xbox Series S' => 15000,   // Harga per jam untuk xbox4
                'Xbox One' => 13000    // Harga per jam untuk xbox3
            ];
...
// Query untuk mengambil data xbox
...
<body>
    ...
    <div id="paymentFormModal" class="payment-form-modal">
        <div class="payment-form-container">
            ...
            <form id="paymentForm" method="POST" action="xbox.php" enctype="multipart/form-data">
    ...
    <script>
        ...
        function openPaymentForm(xboxType) {
            // Isi field Jenis xbox secara otomatis
            document.getElementById("xboxType").value = xboxType;

            // Menampilkan harga per jam sesuai dengan jenis xbox yang dipilih
    ...
    const psType = document.getElementById("xboxType").value;
