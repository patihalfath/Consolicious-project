...
<body>
    ...
    <div class="container">
        <div class="product">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTgADzKoqojC1u6oxuH3liJWno0NrhKxg3Lzw&s" alt="PlayStation 4">
            <div class="product-details">
                <h1>PlayStation 5</h1>
                <p class="price">Rp 5.000.000</p>
                <p>Mainkan PlayStation 4 Sekarang!</p>
                ...
                <form method="POST" action="">
                    ...
                    <input type="hidden" name="product_name" value="PlayStation 4">
