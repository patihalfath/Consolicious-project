...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['rent_now'])) {
    ...
    $sql = "INSERT INTO sewa_switch (user_id, product_name, quantity, rental_date, total_price)
            VALUES (?, ?, ?, ?, ?)";
...
<body>
    ...
    <div class="container">
        <div class="product">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSIhwDr929pDGrqQJSiLMBzSbRR4b_t6-sF9w&s" alt="switch">
            <div class="product-details">
                <h1>switch</h1>
                <p class="price">Rp 5.000.000</p>
                <p>Pengalaman bermain generasi baru dengan switch.</p>
                ...
                <form method="POST" action="">
                    ...
                    <input type="hidden" name="product_name" value="switch">
                    <input type="hidden" name="price" value="5000000"><br>
