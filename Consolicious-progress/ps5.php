...
<body>
    ...
    <div class="container">
        <div class="product">
            <img src="https://asset.kompas.com/crops/OShkHBI40cCFj6mMFFcYmhbhBaw=/187x12:1126x638/750x500/data/photo/2020/06/12/5ee2bae6901d6.jpg" alt="PlayStation 5">
            <div class="product-details">
                <h1>PlayStation 5</h1>
                <p class="price">Rp 8.500.000</p>
                <p>Pengalaman bermain generasi baru dengan PlayStation 5.</p>
                ...
                <form method="POST" action="">
                    ...
                    <input type="hidden" name="price" value="8500000"><br>
